...
class CreditEditScreen extends StatefulWidget {
  ...
  const CreditEditScreen({Key? key, required this.creditCard})
      : super(key: key);
...
class _CreditEditScreenState extends State<CreditEditScreen> {
  ...
  @override
  void initState() {
    cardController.text = '**** **** **** ' + widget.creditCard.number;
    expiryController.text =
        widget.creditCard.expMonth + '/' + widget.creditCard.expYear;
    cvvController.text = widget.creditCard.cvc;
    super.initState();
  }
              ...
              builder: (context, state) {
                ...
                return InkWell(
                  ...
                  onTap: () {
                    if (cardController.text.isNotEmpty &&
                      ...
                      if (exp.length == 2) {
                        String month = exp[0];
                        String year = exp[1];
                        AppBloc.creditCardBloc.add(CreditCardEdit(
                          expMonth: month,
                          expYear: year,
                        ));
                      }
                  ...
                  child: Container(
                    ...
                    child: Text(
                      AppLocalizations.t(context, 'edit'),
                      style: TextStyle(
                        fontSize: 20,
                        fontFamily: AppFont.madeTommySoft,
                        fontWeight: AppFont.wMedium,
